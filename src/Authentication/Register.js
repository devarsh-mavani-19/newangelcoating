    ...
    if (
      ...
      if (!validateEmail(Emailid)) {
        ...
        let finalPhoneNumber =
          ...
          console.log('user collection checking...')
        await f.firestore()
          .collection('users')
          ...
          .get().then( async docs => {
            if(docs.docs.length > 0){
              ...
              console.log('admin...')
              await f.firestore().collection('Admin_Numbers').where('phone',"==",finalPhoneNumber).get().then((docdata) =>{
                  ...
                  if(sellercode != ''){                
                    ...
                    if(validsellercode){
                      ...
                      props.navigation.navigate({
                        routeName: 'Adhar_Card',
                        params: {
                          painter_data : painter_data
                        }
                      });
                    }else{
                      setprocess(0);
