  ...
  render () {
    ...
    const onAccept = async () => {
      ...
      const requestref = firestore
        .collection('Request')
        .doc(this.state.selectedrequestdata.requestID)
      const userref = firestore
        .collection('users')
        .doc(this.state.selectedrequestdata.PainterID)
...
const mapDispatchToProps = dispatch => {
  return {
    Fetch_Request_Data: sid => {
      dispatch(Fetch_Request_Data(sid))
    }
  }
}
